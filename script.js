...
const GOOGLE_API_KEY = "AIzaSyCKtnlsnrbZS5KziATiHG_mO6pkAumDQD0";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            <div class="message__content">
                <img class="message__avatar" src="assets/pro" alt="User avatar">
...
const requestApiResponse = async (incomingMessageElement) => {
    ...
    if (!isITMessage(currentUserMessage)) {
        // Hardcoded response for non-IT-related questions
        messageTextElement.innerText = "Sorry, I'm only limited to IT and system administration questions.";
        messageTextElement.closest(".message").classList.add("message--error");
        incomingMessageElement.classList.remove("message--loading");

        // Reset isGeneratingResponse to allow further requests
        isGeneratingResponse = false;
        return;
    }
...
const handleOutgoingMessage = () => {
    ...
    const outgoingMessageHtml = `
        <div class="message__content">
            <img class="message__avatar" src="assets/image 11.png" alt="User avatar">
            <p class="message__text"></p>
        </div>
    `;
